 ...
 */
final class Version20230119112853 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE schedule (id INT AUTO_INCREMENT NOT NULL, day VARCHAR(255) NOT NULL, noon_open TINYINT(1) NOT NULL, noon_start TIME NOT NULL, noon_end TIME NOT NULL, evening_open TINYINT(1) NOT NULL, evening_start TIME NOT NULL, evening_end TIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
