 ...
 */
final class Version20230131142946 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE restaurant (id INT AUTO_INCREMENT NOT NULL, user_id_id INT DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, post_code VARCHAR(5) DEFAULT NULL, city VARCHAR(255) DEFAULT NULL, phone VARCHAR(255) DEFAULT NULL, max_capacity INT DEFAULT NULL, UNIQUE INDEX UNIQ_EB95123F9D86650F (user_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
